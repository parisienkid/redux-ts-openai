    ...
    return (
        <>
            ...
            <PostContainer>
                    ...
                    <PostHR mb='60px'/>
                    <h3 ref={secondInfoBlock} id='two'>Training AI systems using human feedback</h3>
                    ...
                    <PostHR mb='60px'/>
                    <h3 ref={thirdInfoBlock} id='three'>Training models to assist human evaluation</h3>
                    ...
                    <PostHR mb='60px'/>
                    <h3 ref={fourthInfoBlock} id='four'>Training AI systems to do alignment research</h3>
                    ...
                    <PostHR mb='60px'/>
                    <h3 ref={fifthInfoBlock} id='five'>Limitations</h3>
