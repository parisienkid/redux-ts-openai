...
import { mainTheme, blogTheme, apiTheme, aboutTheme, researchTheme } from '../../core/theme/theme';
...
const Header: FC = () => {
    ...
    const onClickLink = (e: MouseEvent) => {
        ...
        switch(attr) {
            case ('/redux-ts-openai/'):
                return dispatch(changeTheme(mainTheme));
            case ('/redux-ts-openai/api'):
                return dispatch(changeTheme(apiTheme));
            case ('/redux-ts-openai/research'):
                return dispatch(changeTheme(researchTheme));
            case ('/redux-ts-openai/blog'):
                return dispatch(changeTheme(blogTheme));
            case ('/redux-ts-openai/about'):
                return dispatch(changeTheme(aboutTheme));
            default:
                return dispatch(changeTheme(mainTheme));
        }
    }
    ...
    return (
        <HeaderWrapper>
            <Container>
                <NavWrapper>
                    <IconLink onClick={onClickLink} to='/redux-ts-openai/'>
                    ...
                    <HeaderLinks>
                        <HeaderLink onClick={onClickLink} to='/redux-ts-openai/api'>api</HeaderLink>
                        <HeaderLink onClick={onClickLink} to='/redux-ts-openai/research'>research</HeaderLink>
                        <HeaderLink onClick={onClickLink} to='/redux-ts-openai/blog'>blog</HeaderLink>
                        <HeaderLink onClick={onClickLink} to='/redux-ts-openai/about'>about</HeaderLink>
                    </HeaderLinks>
                </NavWrapper>
            </Container>
        </HeaderWrapper>
