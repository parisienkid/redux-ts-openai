        ...
        <HeaderWrapper>
            <Container>
                <NavWrapper>
                    ...
                    <HeaderLinks>
                        <HeaderLink to='/redux-ts-openai/api'>api</HeaderLink>
                        <HeaderLink to='/redux-ts-openai/research'>research</HeaderLink>
                        <HeaderLink to='/redux-ts-openai/blog'>blog</HeaderLink>
                        <HeaderLink to='/redux-ts-openai/about'>about</HeaderLink>
                    </HeaderLinks>
                </NavWrapper>
            </Container>
        </HeaderWrapper>
