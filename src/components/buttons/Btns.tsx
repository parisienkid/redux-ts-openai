...
export const RouterBtn = styled(Link)<IBtn>`
...
export const DefaultBtn = styled.a<IBtn>`
    ${props => props.$nobg && css`
        padding: 10px 5px;
    `}
    background: rgb(${props => props.background});
...
export const StyledRouterBtn = styled(RouterBtn)<IBtn>`
    &:hover {
...
export const StyledDefaultBtn = styled(DefaultBtn)<IBtn>`
    &:hover {
        color: rgba(0,0,0, .65) !important;
    }
    &.active {
